...
proto_6rd_setup() {
	...
	json_get_vars mtu ttl peeraddr ip6prefix ip6prefixlen ip4prefixlen
	...
	ip6subnet=$(echo $ip6subnet | awk -F '/' {'print $1'})
	...
	proto_add_ipv6_route "::$peeraddr" 0 ""
	proto_add_ipv6_route "::" 0 "::$peeraddr" "1023"
