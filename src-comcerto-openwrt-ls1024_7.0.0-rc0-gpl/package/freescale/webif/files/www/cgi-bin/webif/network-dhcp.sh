...
remove_network_form="string|<a href="network-dhcpwifi.sh">@TR<<DHCP on WIFI Interfaces>></a>"	
...
cat /tmp/hosts/odhcpd 2>/dev/null | awk -v date="$(date +%s)" '
