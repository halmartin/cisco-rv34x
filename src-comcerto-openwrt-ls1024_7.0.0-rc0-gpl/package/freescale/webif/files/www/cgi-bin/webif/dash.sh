...
if [ -n "$firewall_present" ]; then
  firewall_link="<a href=\"network-firewall.sh\"><img src=\"../../images/firewall_dash_94px.jpg\" width=\"92px\" height=\"92px\" alt=\"firewall\" title=\"firewall\" /></a>"
fi
vpn_link=""
...
?>
<div id="dash_icons">
	<a href="network.sh"><img src="../../images/nw_dash_94px.jpg" width="92px" height="92px" alt="LAN" title="LAN" /></a>
        <? echo  ${firewall_link} ?>
        <? echo  ${vpn_link} ?>
