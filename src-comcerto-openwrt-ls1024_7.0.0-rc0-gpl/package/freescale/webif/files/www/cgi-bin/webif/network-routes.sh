...
EOF
	...
	if [ "$ipv" = "4" ]
 	then
		cat <<EOF
<tr>
	<td><input type="text" size="10" name="target" value="$FORM_target" /></td>
	<td><input type="text" size="10" name="gateway" value="$FORM_gateway" /></td>
	<td><input type="text" size="10" name="netmask" value="$FORM_netmask" /></td>
...
EOF
	...
	<td><input type="text" size="10" name="rtname" value="$FORM_rtname" /></td>
