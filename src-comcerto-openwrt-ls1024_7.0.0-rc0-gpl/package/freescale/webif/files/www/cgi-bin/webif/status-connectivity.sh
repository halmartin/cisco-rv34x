  ...
  for vap_nw in vap0 vap1 vap2 vap3 vap4 vap5 vap6 vap7; do
    ...
    [ -n "$iface" ] && {
      ...
      wifi_text="$wifi_text <table width=\"96%\" summary=\"Settings\">
                      ...
                      <tr>
                        <td width=\"40%\" class=\"odd\"><span class=\"odd_status\">DHCP Server</span><a href=\"network-dhcp.sh\"><img src=\"../../images/configure_new.gif\" width=\"12px\" height=\"13px\" alt=\"configure\" title=\"configure\" /></a></td>
...
<div class="status_block">
	<div class="settings">
		 <a href="network.sh"><h3><strong>WAN:</strong></h3></a>
			  <div class="status_wan">
					<table width="96%" summary="Settings">
					  ...
					  <tr>
						<td width="40%" class="odd"><span class="odd_status">IP Address</span><a href="network.sh"><img src="../../images/configure_new.gif" width="12px" height="13px" alt="configure" title="configure" /></a></td>
						<td width="60%" class="tr_bg"><? echo -n ${wan_ip_addr} ?></td>
					  </tr>
					  <tr>
						<td width="40%" class="odd"><span class="odd_status">Netmask</span><a href="network.sh"><img src="../../images/configure_new.gif" width="12px" height="13px" alt="configure" title="configure" /></a></td>
						<td width="60%" class="tr_bg"><? echo -n ${wan_netmask} ?></td>
					  </tr>
					  <tr>
						<td width="40%" class="odd"><span class="odd_status">Gateway</span><a href="network.sh"><img src="../../images/configure_new.gif" width="12px" height="13px" alt="configure" title="configure" /></a></td>
						<td width="60%" class="tr_bg"><? echo -n ${wan_gateway} ?></td>
					  </tr>
					  <tr>
						<td width="40%" class="odd"><span class="odd_status">Connection Type</span><a href="network.sh"><img src="../../images/configure_new.gif" width="12px" height="13px" alt="configure" title="configure" /></a></td>
						<td width="60%" class="tr_bg"><? echo -n ${wan_proto} ?></td>
					  </tr>
					  <tr>
						<td width="40%" class="odd"><span class="odd_status">Connected</span><a href="network.sh"><img src="../../images/configure_new.gif" width="12px" height="13px" alt="configure" title="configure" /></a></td>
						<td width="60%" class="tr_bg"><? echo -n ${wan_connected} ?></td>
					  </tr>
					  <tr>
						<td width="40%" class="odd"><span class="odd_status">NAT Enabled</span><a href="network-firewall.sh"><img src="../../images/configure_new.gif" width="12px" height="13px" alt="configure" title="configure" /></a></td>
						<td width="60%" class="tr_bg"><? echo -n ${nat_enable} ?></td>
					  </tr>
					  <tr>
						<td width="40%" class="odd"><span class="odd_status">DNS Servers</span><a href="network.sh"><img src="../../images/configure_new.gif" width="12px" height="13px" alt="configure" title="configure" /></a></td>
						<td width="60%" class="tr_bg"><? echo -n ${dns_srv} ?></td>
					  </tr>
					  <tr>
						<td width="40%" class="odd"><span class="odd_status">Bridged</span><a href="network.sh"><img src="../../images/configure_new.gif" width="12px" height="13px" alt="configure" title="configure" /></a></td>
...
<div class="status_block">
	<div class="settings">
		 <a href="network.sh"><h3><strong>LAN:</strong></h3></a>
