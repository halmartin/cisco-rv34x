...
#define M86XXX_SW_UART_VERSION_Z    2
 ...
 *   Pool definitions
 *****************************************************************************/
#define M86XXX_SW_UART_MSG_SIZE                 (256)    //bytes
...
#define M86XXX_SW_UART_HEADER_SIZE              (128)

#ifdef SW_UART_DSP
#define M86XXX_SW_UART_POOL_DEEP_M2A            (64)    //items in queue
#define M86XXX_SW_UART_POOL_DEEP_A2M            (64)    //items in queue

#define M86XXX_SW_UART_POOL_DEEP_D2A            (64)    //items in queue
#define M86XXX_SW_UART_POOL_DEEP_A2D            (63)    //items in queue
#else
#define M86XXX_SW_UART_POOL_DEEP_M2A            (128)    //items in queue
#define M86XXX_SW_UART_POOL_DEEP_A2M            (127)    //items in queue
#endif
