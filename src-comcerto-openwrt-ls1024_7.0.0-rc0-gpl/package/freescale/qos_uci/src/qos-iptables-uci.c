		...
		{//This policy is of WAN1 interface.
			...
			if(queueconf.queue1)
			{
				...
				if(strcmp(FLOW_PROTO_TCP_UDP_KEYWORD,flow.proto)==0)
				{
					...
					EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcv_iface,"-o ppoe-wan1+ ");
					if(wifiboard && strlen(final_rcvwifi_iface))
						EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcvwifi_iface,"-o ppoe-wan1+ ");

					EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcv_iface,"-o pptp-wan1+ ");
					if(wifiboard && strlen(final_rcvwifi_iface))
						EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcvwifi_iface,"-o pptp-wan1+ ");

					EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcv_iface,"-o l2tp-wan1+ ");
					if(wifiboard && strlen(final_rcvwifi_iface))
						EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcvwifi_iface,"-o l2tp-wan1+ ");
				}
			}
		...
		{//This policy is of WAN2 interface.
			...
			if(queueconf.queue1)
			{
				...
				if(strcmp(FLOW_PROTO_TCP_UDP_KEYWORD,flow.proto)==0)
				{
					...
					EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcv_iface,"-o ppoe-wan2+ ");
					if(wifiboard && strlen(final_rcvwifi_iface))
						EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcvwifi_iface,"-o ppoe-wan2+ ");

					EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcv_iface,"-o pptp-wan2+ ");
					if(wifiboard && strlen(final_rcvwifi_iface))
						EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcvwifi_iface,"-o pptp-wan2+ ");

					EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcv_iface,"-o l2tp-wan2+ ");
					if(wifiboard && strlen(final_rcvwifi_iface))
						EGRESS_IPTABLE_RULE_WITH_TCP_UDP("-p udp ",final_rcvwifi_iface,"-o l2tp-wan2+ ");
				}
			}
