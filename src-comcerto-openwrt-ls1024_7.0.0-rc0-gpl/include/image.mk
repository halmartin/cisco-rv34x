...
define Image/mkfs/yaffs2_rv340
	$(STAGING_DIR_HOST)/bin/mkyaffs2image ${TOPDIR}/vendor/root_yaffs2_rv340/yaffs2_avcsign $(BIN_DIR)/root_avcsign.yaffs2 -v 2>&1 1>/dev/null
	$(STAGING_DIR_HOST)/bin/mkyaffs2image ${TOPDIR}/vendor/root_yaffs2_rv340/yaffs2_configcert $(BIN_DIR)/root_configcert.yaffs2 -v 2>&1 1>/dev/null
	$(STAGING_DIR_HOST)/bin/mkyaffs2image ${TOPDIR}/vendor/root_yaffs2_rv340/yaffs2_webrootdb $(BIN_DIR)/root_webrootdb.yaffs2 -v 2>&1 1>/dev/null
	$(STAGING_DIR_HOST)/bin/mkyaffs2image ${TOPDIR}/vendor/root_yaffs2_rv340/yaffs2_license $(BIN_DIR)/root_license.yaffs2 -v 2>&1 1>/dev/null
	chmod +r $(BIN_DIR)/*.yaffs2
endef
...
ifeq ($(CONFIG_TARGET_comcerto2000_hgw_c2krv340),y)
define Image/rv340package
	( cd ${BIN_DIR} ; \
	cp ${TOPDIR}/vendor/rv340_fw_pack.sh . ; \
	./rv340_fw_pack.sh ${TOPDIR}/vendor \
	)
endef
endif
...
ifeq ($(CONFIG_TARGET_comcerto2000_hgw_c2krv340),y)
	$(call Image/rv340package)
	$(call Image/mkfs/yaffs2_rv340)
endif
endef
