...
$(eval $(call nf_add,IPT_CONNTRACK_EXTRA,CONFIG_NETFILTER_XT_QOSMARK, $(P_XT)xt_qosmark))
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_CONNTRACK_EXTRA,CONFIG_NETFILTER_XT_QOSMARK, $(P_XT)xt_QOSMARK)))
$(eval $(call nf_add,IPT_CONNTRACK_EXTRA,CONFIG_NETFILTER_XT_QOSCONNMARK, $(P_XT)xt_qosconnmark))
$(eval $(if $(NF_KMOD),,$(call nf_add,IPT_CONNTRACK_EXTRA,CONFIG_NETFILTER_XT_QOSCONNMARK, $(P_XT)xt_QOSCONNMARK)))
...
$(eval $(call nf_add,IPT_NAT_EXTRA,CONFIG_IP_NF_MATCH_WEBSTR, $(P_V4)ipt_webstr))
